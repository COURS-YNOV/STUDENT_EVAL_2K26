...
//256813/1504594/2.50/3/2/Transistor BJT NPN
...
(library Library_1
	...
	(symbolDef "BCW66GLT3G" (originalName "BCW66GLT3G")
	...
	(compDef "BCW66GLT3G" (originalName "BCW66GLT3G") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BCW66GLT3G"))
		...
		(attr "Manufacturer_Part_Number" "BCW66GLT3G")
		(attr "Mouser Part Number" "863-BCW66GLT3G")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/BCW66GLT3G?qs=XfkxeqX9xWXeTiewInI3Nw%3D%3D")
		(attr "Arrow Part Number" "BCW66GLT3G")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/bcw66glt3g/on-semiconductor?region=europe")
		(attr "Description" "NPN Bipolar Transistor")
		(attr "<Hyperlink>" "http://www.onsemi.com/pub/Collateral/BCW66GLT1-D.PDF")
		(attr "<Component Height>" "1.11")
		(attr "<STEP Filename>" "BCW66GLT3G.stp")
